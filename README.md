...
<center><img src="/readme-images/teaser.png" width="75%" height="75%"></center>
...
<center><img src="/readme-images/cropped_samples.png" width="75%" height="75%"></center>
...
<center><img src="/readme-images/dataset_stats1.png" width="70%" height="70%"></center>

The dataset distribution is long-tailed resulting in class imbalance to different degrees.

<center><img src="/readme-images/dataset_stats2.png" width="70%" height="70%"></center>

### How to Use.
We use YOLOv5L for vehicle localization and Label Relation Graphs Enhanced HRN for fine-grained classification. Performance comparison of our model with baseline detectors on our test set:

| Model | L-1 mAP | L-2 mAP | L-3 mAP |
| ------------- | ------------- | ------------- | ------------- |
| Faster RCNN  | 54.43%  | 41.46% | 31.92% |
| YOLOv5L  | 61.70%  | 42.40% | 32.75% |
| **YOLOv5L**  | **83.21%**  | **59.02%** | **48.40%** |
