...
if __name__ == '__main__':
	...
	train_data_dir = "./cropped/crop_train" #train_data_dir = "/home2/praffulkumar/cp_wks/datasets/IDD_FGD_L3/train/crop_img"
	test_data_dir = "./cropped/crop_test"#test_data_dir = "/home2/praffulkumar/cp_wks/datasets/IDD_FGD_L3/val/crop_img"
	train_list = "./cropped/train_list.txt"#train_list = "/home2/praffulkumar/cp_wks/datasets/IDD_FGD_L3/train/train_list.txt"
	test_list = "./cropped/test_list.txt"#test_list = "/home2/praffulkumar/cp_wks/datasets/IDD_FGD_L3/val/val_list.txt"
        ...
        levels = 3
        total_nodes = 281
        trainset = FGVDDataset(train_data_dir, train_list, transform_train, re_level='class', proportion=0.0)
        # Uncomment this line for testing OA results
        testset = FGVDDataset(test_data_dir, test_list, transform_test, re_level='class', proportion=0.0)
